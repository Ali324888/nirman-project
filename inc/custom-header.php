 ...
 *
 * @uses creation_header_style()
 */
function creation_custom_header_setup() {
...
add_action( 'after_setup_theme', 'creation_custom_header_setup' );

if ( ! function_exists( 'creation_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see creation_custom_header_setup().
	 */
